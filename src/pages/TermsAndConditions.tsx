...
const TermsAndConditions = () => {
    ...
    return (
        <main className="terms-and-conditions-page">
            <h1 className="terms-and-conditions-heading-1">TERMS AND CONDITIONS</h1>
            ...
            <h2 className="terms-and-conditions-heading-2">Intellectual Property</h2>
            ...
            <h2 className="terms-and-conditions-heading-2">Accounts</h2>
            ...
            <h2 className="terms-and-conditions-heading-2">Sale of Goods</h2>
            ...
            <h2 className="terms-and-conditions-heading-2">Payments</h2>
            ...
            <h2 className="terms-and-conditions-heading-2">Shipping and Delivery</h2>
            ...
            <h2 className="terms-and-conditions-heading-2">Consumer Protection Law</h2>
            ...
            <h2 className="terms-and-conditions-heading-2">Limitation of Liability</h2>
            ...
            <h2 className="terms-and-conditions-heading-2">Indemnity</h2>
            ...
            <h2 className="terms-and-conditions-heading-2">Applicable Law</h2>
            <p>These terms and conditions are governed by the laws of the Commonwealth of Massachusetts.</p>

            <h2 className="terms-and-conditions-heading-2">Dispute Resolution</h2>
            ...
            <h2 className="terms-and-conditions-heading-2">Severability</h2>
            ...
            <h2 className="terms-and-conditions-heading-2">Changes</h2>
            ...
            <h2 className="terms-and-conditions-heading-2">Contact Details</h2>
            <p>Please contact us if you have any questions or concerns. Our contact details are as follows:</p>

            <div className="terms-and-conditions-address">
                <span className="terms-and-conditions-co-name">Infinite Bliss</span>
