...
export const albums: Album[] = [
    ...
    },
    {
        ...
        albumDesc: [
            'After signing with the label prior to the August 2015' + 
    ...
    },
    {
        ...
        albumDesc: [
            'With “Hidden History of the Human Race”, Denver, Colorado’s cosmic' + 
    ...
    },
    {
        ...
        tracklist: ['Io', 'Ea'],
        albumDesc: [
            'Spawned in the Fall of 2011, Cosmic Death Metal initiates BLOOD INCANTATION,' + 
    ...
    },
    {
        ...
        artist: 'Chat Pile',
        imgs: [
            'chat-pile_this-dungeon-earth-remove-your-skin-please-cover', 
            'chat-pile_this-dungeon-earth-remove-your-skin-please-lp_1'
        ],
    ...
    },
    {
        ...
        productType: 'LP',
        artist: 'Chat Pile',
        imgs: ['chat-pile_gods-country-cover', 'chat-pile_gods-country-lp_1'],
        desc: 'God\'s Country',
        price: 21.99,
    ...
    },
    {
        ...
        artist: 'Chat Pile',
        imgs: [
            'chat-pile_tenkiller-soundtrack-cover', 
        ...
        albumDesc: [
            'Oklahoma\'s Chat Pile have had an exciting 2022; they released' + 
    ...
    },
    {
        ...
        productType: 'CD',
        artist: 'Deafheaven',
        imgs: ['deafheaven_sunbather-cover'],
        desc: 'Sunbather',
        price: 14.99,
        dateAdded: new Date(2013, 5, 13),
        tracklist: [
    ...
    },
    {
        ...
        productType: 'CD',
        artist: 'Deafheaven',
        imgs: ['deafheaven_new-bermuda-cover'],
        desc: 'New Bermuda',
        price: 14.99,
        dateAdded: new Date(2015, 9, 3),
        albumDesc: ['Released via ANTI-RECORDS.']
    },
    {
        ...
        artist: 'Deafheaven',
        imgs: [
            'deafheaven_ordinary-corrupt-human-love-cover',
    ...
    },
    {
        ...
        productType: 'CD',
        artist: 'Deafheaven',
        imgs: ['deafheaven_ordinary-corrupt-human-love-cover'],
        desc: 'Ordinary Corrupt Human Love',
        price: 14.99,
        dateAdded: new Date(2018, 6, 13),
        tracklist: [
    ...
    },
    {
        ...
        productType: '2XLP',
        artist: 'Deafheaven',
        imgs: ['deafheaven_infinite-granite-cover', 'deafheaven_infinite-granite-lp_1'],
        ...
        albumDesc: [
            'Over the course of their first ten years, Deafheaven\'s music vacillated between' + 
    ...
    },
    {
        ...
        productType: 'CD',
        artist: 'Deafheaven',
        imgs: ['deafheaven_infinite-granite-cover'],
        desc: 'Infinite Granite',
        price: 13.99,
        dateAdded: new Date(2021, 7, 20),
        tracklist: [
    ...
    },
    {
        ...
        artist: 'Nails',
        imgs: [
            'nails_unsilent-death-cover', 
            'nails_unsilent-death-lp_1'
        ],
        desc: 'Unsilent Death',
        price: 21.99,
        ...
        albumDesc: [
            'The 10th Anniversary version is the original ten-song album released in 2010,' + 
    ...
    },
    {
        ...
        productType: 'CD',
        artist: 'Nails',
        imgs: ['nails_unsilent-death-cover'],
        desc: 'Unsilent Death',
        price: 14.99,
        dateAdded: new Date(2010, 2, 15),
        tracklist: [
    ...
    },
    {
        ...
        albumDesc: [
            'NAILS is beyond brutality. These grindcore tyrants of the American underground' + 
    ...
    },
    {
        ...
        artist: 'Nails',
        imgs: [
            'nails_you-will-never-be-one-of-us-cover'
        ],
        desc: 'You Will Never Be One Of Us',
        price: 24.99,
        dateAdded: new Date(2016, 0, 17),
        tracklist: [
    ...
    },
    {
        ...
        artist: 'Bell Witch',
        imgs: [
            'bell-witch_four-phantoms-cover',
            'bell-witch_four-phantoms-2xlp_1', 
        ],
        desc: 'Four Phantoms',
        price: 34.99,
    ...
    },
    {
        ...
        tracklist: ['Mirror Reaper'],
        albumDesc: [
            'With their third full-length album, “Mirror Reaper,” Seattle\'s doom' +
    ...
    },
    {
        ...
        artist: 'Bell Witch',
        imgs: [
            'bell-witch_futures-shadow-2xlp_1', 
            'bell-witch_futures-shadow-2xlp_2'        
        ],
        desc: 'Future\'s Shadow Part 1 - The Clandestine Gate',
        price: 29.99,
        dateAdded: new Date(2023, 5, 9),
        tracklist: ['The Clandestine Gate'],
        albumDesc: [
            'For their new album,The Clandestine Gate, bassist Dylan Desmond and drummer Jesse' + 
    ...
    },
    {
        ...
        productType: '2XCD',
        artist: 'Bell Witch',
        imgs: ['bell-witch_futures-shadow-2xlp_1'],
        desc: 'Future\'s Shadow Part 1 - The Clandestine Gate',
        price: 29.99,
        dateAdded: new Date(2023, 5, 9),
        tracklist: ['The Clandestine Gate'],
    ...
    },
    {
        ...
        productType: 'LP',
        artist: 'The Body',
        imgs: ['the-body_christs-redeemers-cover'],
        ...
        albumDesc: [
            'It has been said by more than a few intrepid listeners that The Body' + 
    ...
    },
    {
        ...
        productType: '2XLP',
        artist: 'The Body',
        imgs: ['the-body_i-shall-die-here-earth-triumphant-cover'],
        ...
        tracklist: [
            ...
            'Our New Genesis',
            'No Sadness in the Many',
            'A Testament to Willingness',
            'A Cloud Broke Open',
            'Wind on the Ocean, Wind on the Trees',
            'Death at a Great Distance',
        ],
        albumDesc: [
            'I Shall Die Here / Earth Triumphant is an expanded edition of the' + 
    ...
    },
    {
        ...
        productType: '2XLP',
        artist: 'The Body',
        imgs: ['the-body_no-one-deserves-happiness-cover'],
        ...
        albumDesc: [
            'On No One Deserves Happiness, The Body\ns Chip King and Lee Buford' + 
    ...
    },
    {
        ...
        productType: '2XLP',
        artist: 'The Body',
        imgs: ['the-body_i-have-fought-against-it-but-i-cant-any-longer-cover'],
        ...
        tracklist: [
            ...
            'Ten Times A Day, Every Day, A Strange'
        ],
        albumDesc: [
            'With each release, the duo of Lee Buford and Chip King' + 
    ...
    },
    {
        ...
        tracklist: [
            ...
            'Wanderings (Remixed by Andrew Nolan)',
            'An Urn (Remixed by Sow Discord)',
            'Can Carry No Weight (Remixed by Peter Rehberg)',
            'Western Dub (Remixed by Seth Manchester)',
            'Hallow Hollow (Remixed by Lingua Ignota)'
        ],
        albumDesc: [
            'The Body was founded by drummer Lee Buford and guitarist/vocalist' + 
    ...
    },
    {
        ...
        artist: 'The Body',
        imgs: [
            'the-body_ive-seen-all-i-need-to-see-cover',
            'the-body_ive-seen-all-i-need-to-see-lp_1',
            'the-body_ive-seen-all-i-need-to-see-lp_2',
            'the-body_ive-seen-all-i-need-to-see-lp_3',
            'the-body_ive-seen-all-i-need-to-see-lp_4',
            'the-body_ive-seen-all-i-need-to-see-lp_5',
        ],
        desc: 'I\'ve Seen All I Need to See',
        price: 29.99,
        dateAdded: new Date(2021, 0, 29),
        tracklist: [
            'A Lament',
        ...
        albumDesc: [
            'Over the course of two decades The Body, Lee Buford and Chip King,' +
            ' have consistently challenged assumptions and defied categorization,' +
            ' redefining what it means to be a heavy band. On I\'ve Seen All I Need' +
            ' To See, they test the boundaries of the studio to explore the extremes' +
            ' and microtonality of distortion to find its maximal impact. Their most' +
            ' incisively bleak, a towering monolith of noise, album to date Buford\'s' +
            ' booming, resolute drums paired with King\'s obliterated guitar and howl.' +
            ' Course, bristling distortion contorts every instrument, with samples of' +
            ' spoken word, cymbals, toms and King\'s already noxious tone emerging from' +
            ' layers of feedback. The recording studio remains indelible to The Body\'s' +
            ' creative process. Together with engineer Seth Manchester of Machines With' +
            ' Magnets, they capture the complexities of distorted sound in stunning detail.' +
            ' The clarity and the cacophony exceed anything they\'ve created before,' +
            ' morphing desolate, festering soundscapes into an exhilarating sonic universe.' +
            ' Buford often lays the framework for songs from the drums up, mirroring hip hop' +
            ' production. I\'ve Seen All I Need To See trades out 808s and The Body\'s' +
            ' self-sampling for live instruments with a focus on expanding mutations of' +
            ' sound from more limited sources. The results are remarkably rich textural' +
            ' bombardments. Throughout, The Body deliver oppressive noise with potent lucidity,' +
            ' replicating the overwhelming sound of their live performances in revelatory detail.' +
            ' I\'ve Seen All I Need To See demonstrates not only The Body\'s fearless spirit and' +
            ' vicious edge, but their intellectual musical heft through its explorations of' +
            ' distorted sound and the power of distorted sounds\' interplay. Composer Roger' +
            ' Johnson said "Noise is power, but is generally represented as negative, chaotic,' +
            ' dangerous, violent, when it comes... from those marginalized from power. Noise' +
            ' is also an expression of freedom, a \'liberation of sound.\'" The Body are sound' +
            ' liberators capable of mining and extracting remarkable details from the most' +
            ' manipulated and distorted sound sources. I\'ve Seen All I Need To See is a' +
            ' groundbreaking work and an ecstatic listen, whether seen as a testament to' +
            ' catharsis in oblivion, an opus of inexorable dread or a wholly liberating' +
            ' adventure.'
        ]
    },
    {
        ...
        artist: 'Ragana',
        imgs: [
            'ragana_desolations-flower-cover', 
            'ragana_desolations-flower-lp_1'
        ],
        ...
        albumDesc: [
            'Ragana is a duo whose members alternate duties on drums,' + 
    ...
    },
    {
        ...
        albumDesc: [
            ...
            ' all facets of it; “Death is a new beginning, just a word to inspire a different' + 
            ' vision of a future,” Ragana comments. Album closer “In the Light of the Burning' + 
            ' World” brings Desolation\'s Flower all together: the final lyric lamets “We live' + 
            ' in the light of the burning world,” cascading from rage and survival into catharsis' + 
            ' and compassion.'
        ]
    },
    {
        ...
        imgs: [
            'ragana_desolations-flower-cover', 
            'ragana_desolations-flower-tape'
        ],
        desc: 'Desolation\'s Flower',
        price: 14.99,
        dateAdded: new Date(2023, 7, 10),
    ...
    },
    {
        ...
        productType: 'LP',
        artist: 'Ragana',
        imgs: ['ragana_you-take-nothing-cover'],        
        ...
        albumDesc: [
            'Queer antifascist black metal/doom from so-called Oakland, CA & Olympia, WA.',
    ...
    },
    {
        ...
        artist: 'Knoll',
        imgs: [
            'knoll_metempiric-cover', 
            'knoll_metempiric-lp_1'
        ],        
        desc: 'Metempiric',
        price: 24.99,
    ...
    },
    {
        ...
        albumDesc: [
            'A new version of Cloud Rat\'s incredible debut, remastered with some' + 
    ...
    },
    {
        ...
        albumDesc: [
            'Cloud Rat finally releases a vinyl edition of the now-extended Cliff' + 
    ...
    },
    {
        ...
        albumDesc: [
            'The new masterpiece from grinders Cloud Rat is the pinnacle of the' + 
    ...
    },
    {
        ...
        artist: 'Full of Hell',
        imgs: [
            'full-of-hell_garden-of-burning-apparitions-cover',
        ...
        albumDesc: [
            'FULL OF HELL return with their highly anticipated new album, Garden Of' + 
    ...
    },
    {
        ...
        artist: 'Full of Hell',
        imgs: [
            'full-of-hell_trumpeting-ecstasy-cover',
        ...
        albumDesc: [
            'Maryland/Pennsylvania experimental death-noise' +
    ...
    },
    {
        ...
        artist: 'Full of Hell',
        imgs: [
            'full-of-hell_weeping-choir-cover',
        ...
        albumDesc: [
            'FULL OF HELL make their Relapse debut' +
    ...
    },
    {
        ...
        imgs: [
            'portrayal-of-guilt_devil-music-cover',
        ...
        albumDesc: [
            'Plunge deeper into the deranged world of PORTRAYAL OF GUILT' +
    ...
    },
    {
        ...
        albumDesc: [
            'To say Portrayal of Guilt write grim songs is an understatement.' +
    ...
    },
    {
        ...
        artist: 'Soft Kill',
        imgs: [
            'soft-kill_canary-yellow-cover', 
            'soft-kill_canary-yellow-lp_1'
        ],        
        desc: 'Canary Yellow',
        price: 24.99,
    ...
    },
    {
        ...
        artist: 'Soft Kill',
        imgs: [
            'soft-kill_premium-drifter-cover', 
            'soft-kill_premium-drifter-lp_1'
        ],        
        ...
        tracklist: [
            'True Lies (Demo)',
            'Build Your Prison Walls (Demo)',
            'The Other Side (Demo)',
            'Premium Drifter (Demo)',
            'Swept Away (Demo)',
            'Glasshouse (Demo)',
            'Your Very Worst (Demo)',
            'I Left You Hanging (Demo)'
        ],
        albumDesc: [
            'A collection of demos written and recorded over the course of the' + 
    ...
    },
    {
        ...
        artist: 'Soft Kill',
        imgs: [
            'soft-kill_metta-world-peace-cover', 
            'soft-kill_metta-world-peace-lp_1'
        ],        
        ...
        tracklist: [
            ...
            'Behind The Rain',
            'Past Life II',
            'Paranoid feat. Evil Pimp',
            'Molly',
            'Veil of Pain feat. N8NOFACE',
            'Fuck Boy'
        ],
        albumDesc: [
            'Primarily recorded during a transitional move, "Metta World Peace"' +
    ...
    },
    {
        ...
        tracklist: [
            ...
            'Feign',
            'Reminders',
            'Limelight" (featuring Manchester Orchestra)',
            'Exit Row',
            'Savoring',
            'A Broadcast',
            'I\'ll Be Your Host',
    ...
    },
    {
        ...
        imgs: [
            'primitive-man_insurmountable-cover', 
            'primitive-man_insurmountable-12in_1'
        ],        
        desc: 'Insurmountable',
        price: 24.99,
        ...
        tracklist: [
            ...
            'Boiled',
            'Cage Intimacy',
            'Quiet (Smashing Pumpkins Cover)'
        ],
        albumDesc: [
            'Listening to Primitive Man is a devastating experience of Doom' +     
    ...
    },
    {
        ...
        albumDesc: [
            'PRIMITIVE MAN return with the extreme, terrifying and confrontational new' + 
    ...
    },
    {
        ...
        imgs: [
            'emma-ruth-rundle_live-at-roadburn-cover', 
            'emma-ruth-rundle_live-at-roadburn-2xlp_1'
        ],
    ...
    },
    {
        ...
        artist: 'Emma Ruth Rundle',
        imgs: [
            'emma-ruth-rundle_marked-for-death-cover', 
            'emma-ruth-rundle_marked-for-death-lp_1'
        ],
    ...
    },
    {
        ...
        artist: 'Emma Ruth Rundle',
        imgs: [
            'emma-ruth-rundle_on-dark-horses-cover',
    ...
    },
    {
        ...
        artist: 'Emma Ruth Rundle',
        imgs: [
            'emma-ruth-rundle_engine-of-hell-cover', 
            'emma-ruth-rundle_engine-of-hell-lp_1'
        ],
        desc: 'Engine of Hell',
        price: 23.99,
        ...
        albumDesc: [
            'Emma Ruth Rundle\'s forthcoming Engine of Hell is stark, intimate, and unflinching.' +
    ...
    },
    {
        ...
        productType: 'CD',
        artist: 'Emma Ruth Rundle',
        imgs: ['emma-ruth-rundle_engine-of-hell-cover'],
        desc: 'Engine of Hell',
        price: 14.99,
        dateAdded: new Date(2021, 10, 5),
        tracklist: [
    ...
    },
    {
        ...
        artist: 'Emma Ruth Rundle',
        imgs: [
            'emma-ruth-rundle_eg2-dowsing-voice-cover', 
            'emma-ruth-rundle_eg2-dowsing-voice-lp_1'
        ],
        ...
        albumDesc: [
            'Emma Ruth Rundle\'s second installment in her Electric Guitar series, EG2:' + 
    ...
    },
    {
        ...
        imgs: [
            'spectral-wound_infernal-decadence-cover',
            'spectral-wound_infernal-decadence-lp_1'
        ],
        ...
        tracklist: [
            ...
            'Feral Gates Of Flesh',
            'La Nuit Froide de L\'oubli',
            'Imperial Thanatosis'
        ],
        albumDesc: ['LP re-issue of SPECTRAL WOUND\'s 2018 album “Infernal' +
        ' Decadence” initially released by Vendetta Records, now re-issued' +
        ' by the band\'s current label Profound Lore Records and available' + 
        ' once again in physical LP format with expanded packaging: gatefold' + 
        ' jacket with foil printing, a 12-page A5 booklet, and a fold out' + 
        ' poster.']
    },
    {
        ...
        productType: 'LP',
        artist: 'Spectral Wound',
        imgs: ['spectral-wound_a-diabolic-thirst-cover'],
    ...
    },
    {
        ...
        albumDesc: [
            'Philadelphia\'s DEVIL MASTER\'s roots in' +
    ...
    },
    {
        ...
        imgs: ['divide-and-dissolve_systemic-lp'],
        desc: 'Systemic',
        price: 27.99,
        ...
        albumDesc: [
            'Divide and Dissolve\'s new album Systemic examines the' +  
            ' systems that intrinsically bind us and calls for a system that' + 
            ' facilitates life for everyone. It\'s a message that fits with the' + 
            ' band\'s core intention: to make music that honours their ancestors' +  
            ' and Indigenous land, to oppose white supremacy, and to work towards' + 
            ' a future of Black and Indigenous liberation.',

            'Like its predecessor Gas Lit, Systemic was produced by Ruban Neilson' + 
            ' of Unknown Mortal Orchestra.',
            
            'You can feel the deep intention in Divide and Dissolve\'s music. Their' + 
            ' dense sound is overwhelmingly heavy; a dissonant pounding of percussion,' + 
            ' guitars, piano, synths and saxophone, interwoven with passages of orchestral' + 
            ' beauty that give a feeling of respite. Systemic is a thick wash of sound,' + 
            ' equal parts beauty and anguish and creates a wholly encompassing experience' + 
            ' for even a casual listener.'
        ]
    },
    {
        ...
        artist: 'Oathbreaker',
        imgs: [
            'oathbreaker_maelstrom-lp_1',
            'oathbreaker_maelstrom-lp_2',
            'oathbreaker_maelstrom-lp_3',
            'oathbreaker_maelstrom-lp_4',
            'oathbreaker_maelstrom-lp_5'
        ],
        desc: 'Mælstrøm',
        price: 27.99,
        dateAdded: new Date(2011, 0, 15),
        tracklist: [
            'Orgin',
            'Hierophant',
            'Fate Is High',
        ...
        albumDesc: ['Released via DEATHWISH INC. in 2011.']
    },
    {
        ...
        productType: 'CD',
        artist: 'Oathbreaker',
        imgs: ['oathbreaker_eros-anteros-cd'],
        desc: 'Eros|Anteros',
        price: 14.99,
        dateAdded: new Date(2013, 7, 20),
        tracklist: [
            'Beeltenis',
        ...
        albumDesc: [
            'Released via Deathwish Inc. in 2013.',

            '"Eros|Anteros" is the breathtaking follow up to Oathbreaker\'s' + 
            ' critically acclaimed "Maelstrom" album. Where "Maelstrom" acted as' + 
            ' individual fragments of shrapnel, "Eros|Anteros" is a shockwave of' + 
            ' sound. It is Oathbreaker\'s story of love and the anti-love (life and' + 
            ' death), and the growth they have experienced through these trials.',
            
            'In opener "Beeltenis" (Dutch for "Portrait") layers of melodious' + 
            ' guitar cry out to one another through the blackness. Acting as a' + 
            ' ghostlike warning before Oathbreaker whips calm to chaos. "No Rest' + 
            ' for the Weary" then abruptly crashes forward with breakneck speed and' + 
            ' from there the floodgates of "Eros|Anteros" are open. As vocalist Caro' + 
            ' Tanghe lets out the hair raising screams of "I\'ll never know what it' + 
            ' means - this deadly calm inside", it\'s clear that this album is more' + 
            ' potent and personal than most heavy music; this is a collective soul' + 
            ' searching for the band. This is most apparent in brother and sister' + 
            ' songs "As I Look Into the Abyss" and "The Abyss Looks Into Me". A' + 
            ' stunning pairing that shows Oathbreaker racing through razor sharp' + 
            ' metallic riffing before erupting into a vicious emotional explosion.' + 
            ' This quarrel continues throughout the "Eros|Anteros", finally coming' + 
            ' to a head in the haunting closer "Clair Obscur". An eleven minute epic' + 
            ' that carefully balances shoe-gaze leanings with their wounded post-metal' + 
            ' heart.'
        ]
    },
    {
        ...
        artist: 'Oathbreaker',
        imgs: [
            'oathbreaker_rheia-2xlp_1',
            'oathbreaker_rheia-2xlp_2',
            'oathbreaker_rheia-2xlp_3',
            'oathbreaker_rheia-2xlp_4',
            'oathbreaker_rheia-2xlp_5'
        ],
        desc: 'Rheia',
        price: 34.99,
        dateAdded: new Date(2016, 8, 30),
        ...
        albumDesc: [
            'Released via DEATHWISH INC. in September 2016.',

            '“Rheia” is the groundbreaking album from Belgium\'s Oathbreaker.' + 
            'Engineered, mixed, and mastered by Jack Shirley (Deafheaven,' + 
            'Loma Prieta), “Rheia” is a true game changer for the genre.' + 
            'Blurring lines and dissolving the boundaries of heavy music' + 
            'as we know it today.', 

            'Opener “10:56” begins with a haunting guitar riff and Caro' + 
            ' Tanghe\'s beautifully sung vocal before abruptly soaring to' + 
            ' new heights with “Second Son of R”. Its blasts of melody' + 
            ' mutate into a blackened buzz while waves of tempo changes' + 
            ' pound down with intense emotional weight. “Being Able To' + 
            ' Feel Nothing” then rolls in like a storm. Chaotically breaking' + 
            ' apart to reveal the eye before churning once again. “Stay Here' + 
            ' / Accroche-Moi” is an otherworldly reverb drenched acoustic number' + 
            ' that leads to “Needles In Your Skin”. A deeply personal song that' + 
            ' showcases the artistic strength vulnerability brings. It\'s hard to' + 
            ' believe that this is just the half way point of this post everything' + 
            ' masterwork. “Immortals” then unfurls as a goose bump inducing monster.' + 
            ' This leads to the ambitious “I\'m Sorry, This Is”, “Where I Live”, and' + 
            ' “Where I Leave”; A musical triptych that needs to be heard to be' + 
            ' believed. All of it comes to an end with mesmerizing closer “Begeerte”.' + 
    ...
    },
    {
        ...
        artist: 'Undeath',
        imgs: [
            'undeath_lesions-of-a-different-kind-lp_1',
            'undeath_lesions-of-a-different-kind-lp_2',
            'undeath_lesions-of-a-different-kind-lp_3',
        ],
        desc: 'Lesions of a Different Kind',
        price: 27.99,
        dateAdded: new Date(2020, 4, 22),
        tracklist: [
            ...
            'Archfiend Coercion Methods'
        ],
        albumDesc: [
            'Skull crushing death metal reigns supreme; if the blood-spattered' +
            ' glory of Carcass is your (body) bag, if the headbang-inducing brutality of' +
            ' Cannibal Corpse is too much for you to resist, then UNDEATH have served up a' +
            ' feast for you. Lesions Of A Different Kind is the sound of three lifetimes of' + 
            ' subterranean sickness and death metal worship coalescing in a severe brain-bludgeoning' +
    ...
    },
    {
        ...
        artist: 'Undeath',
        imgs: [
            'undeath_its-time-to-rise-from-the-grave-lp_1',
            'undeath_its-time-to-rise-from-the-grave-lp_2'
        ],
        desc: 'It\'s Time... to Rise From the Grave',
        price: 27.99,
        ...
        albumDesc: [
            'Death is their chief lyrical concern and avowed metal subgenre,' + 
            ' but the members of Rochester, New York’s UNDEATH share a decidedly' + 
            ' life-affirming outlook. “I think all of us love death metal so much,”' + 
            ' vocalist Alexander Jones explaines, “because when it’s done well, it' + 
            ' sits right at the intersection of pure musicianship and mindless fun.”' + 
            ' There is a specific type of fun he is referring to: the spine-tingling' + 
            ' thrill of campy horror movies, of screaming unintelligibly for no' + 
            ' reason at all.  It is the restless, ridiculous heartbeat underlying' + 
            ' UNDEATH\'s music.',

            'If Undeath sound hyper-focused on one style, their commitment to this' + 
            ' vision is also part of their appeal. The lyrics take delight in exploring' + 
            ' death, torture, and general disfigurement from every angle. The message is' + 
            ' plain: The human body is disgusting. Man’s capacity for evil knows no limits.' + 
            ' The end is near and always looming closer. Undeath excel by soundtracking' + 
            ' these thoughts through pitch-perfect metal bursting with energy. For them,' + 
    ...
    },
    {
        ...
        productType: 'CD',
        artist: 'Undeath',
        imgs: ['undeath_its-time-to-rise-from-the-grave-lp_1'],
        desc: 'It\'s Time... to Rise From the Grave',
        price: 16.99,
        dateAdded: new Date(2022, 9, 23),
        tracklist: [
